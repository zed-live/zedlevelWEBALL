...
const faq: FaqItem[] = [
  {
    ...
    a: "الدورة مصمّمة تبدأ معك من البداية تمامًا عشان ما يفوتك شيء أو يكون عندك أي ضعف في تأسيسك.",
  },
  {
    q: "كم مدة الدورة؟",
    a: "باقة التعليم الذاتي تنجزها في أسبوعين إلى أربع أسابيع حسب التزامك. والأسبوع المكثف المباشر يكون عادةً آخر أسبوع بعد الدورة أو الأسبوع الذي يليه، عشان تطبّق وتمارس اللي تعلمته خلال الدورة.",
  },
  {
    ...
    a: (
      <ul className="list-disc space-y-2 pe-5">
        <li>
          باقة التعليم الذاتي، تشمل كل المميزات إلا الحصص المباشرة في الأسبوع
          المكثف.
        </li>
        <li>
          الباقة الكاملة، تشمل كل المميزات + الأسبوع المكثف (حصص مباشرة مكثفة مع
          المعلم وقروب صغير).
        </li>
      </ul>
    ),
