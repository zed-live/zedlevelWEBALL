...
const faq: FaqItem[] = [
  {
    q: "أنا مبتدئ من الصفر أو أساسي ضعيف، تناسبني؟",
    a: "نعم، الدورة مصممة اللي يبدأ من الصفر تمامًا، أو اللي جرّب قبل وتعثر وأساسه مو متين. والشرح كله بالعربي.",
  },
  {
    q: "كم مدة الدورة وكم تاخذ من وقتي يوميًا؟",
    a: "يوميًا 20 دقيقة تقريبًا، تزيد أو تنقص. وبالوتيرة العادية تخلصها بـ4 أسابيع + أسبوع مراجعة مكثف. ولو متحمس تقدر تنجزها بأسبوعين، وأقصى مدة لإنجازها 40 يوم من تاريخ البدء.",
  },
  {
    q: "الدروس مباشرة أو مسجلة؟",
    a: "رحلتك اليومية ٢٦ درس مسجّلة بجودة عالية، تتابعها بأنسب وقت لك في يومك، وتعيدها متى ما تبي أثناء فترة الاشتراك. الحصص المباشرة تجي بالأسبوع المكثف الأخير، وهي ضمن الباقة الكاملة. والدروس تنفتح بالترتيب عشان أساسك يُبنى صح بدون قفز، ومشرف يذكّرك على الواتساب عشان ما تتراكم عليك الدروس، بالإضافة لقروب واتساب تسأل فيه.",
  },
  {
    ...
    a: (
      <div className="space-y-3">
        <p>
          باقة التعليم الذاتي بـ١٩٩ ريال، تعطيك الدروس المسجّلة + كتيّب التمارين
          والملخصات والفلاش كاردز.
        </p>
        <p>
          والباقة الكاملة بـ٤٩٩ ريال: كل اللي بباقة التعليم الذاتي + أسبوع ممارسة
          مكثف مع المعلم + الاختبار النهائي + الشهادة.
        </p>
        <p>الدفع آمن عبر سلة، وتقدر تتواصل واتساب ويخلّصونك.</p>
      </div>
    ),
  },
  {
    q: "وش الفرق بين الباقتين بالضبط؟",
    a: "باقة الـ٤٩٩ تضيف على باقة الـ١٩٩ الأسبوع المكثف بحصصه المباشرة + الاختبار النهائي + الشهادة. أسبوع من الحصص المباشرة المكثفة عشان تطبّق وتمارس اللي تعلمته وتتدرب مع المعلم وقروب صغير، والحصص تشمل تدريبات على مهارة الكتابة.",
  },
  {
    q: "وش هو أسبوع الممارسة المكثف؟",
    a: "أسبوع ختامي للمشتركين بالباقة الكاملة: ٦ حصص مباشرة مع معلمك بمجموعة صغيرة (١–٧ متعلمين)، تطبّق فيها كل اللي تعلمته مع تركيز خاص على مهارة الكتابة، وتختمه بالاختبار. مدة الحصص من ٣٠ دقيقة إلى ساعة.",
  },
  {
    q: "وش التحول اللي بتصنعه لي الدورة؟",
    a: "بإذن الله بتصير تقرأ وتنطق صح، تعرّف عن نفسك وتسأل وتجاوب، وتتكلم عن عائلتك وبيتك وأكلك ويومك بجمل صحيحة، مع +٤٦٠ كلمة و١٥ قاعدة أساسية. فبتبني أساس متين تنطلق منه للمستويات الأعلى.",
  },
];
