...
/**
 * The "result line" callout used above the checklist — a rounded white card
 * with a soft shadow and a gold accent bar on the start edge. An optional
 * `note` renders below the body in the primary color.
 */
export function ResultLine({
  ...
  return (
    <div className="relative mt-4 overflow-hidden rounded-2xl bg-white px-5 py-4 text-center shadow-[0_8px_24px_-12px_rgba(15,23,41,0.25)] ring-1 ring-ink/[0.06]">
      <span
        aria-hidden
        className="absolute inset-y-0 end-0 w-1.5 rounded-full bg-accent"
      />
