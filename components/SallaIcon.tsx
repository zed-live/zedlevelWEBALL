/**
 * The official Salla brand mark (from Simple Icons, CC0). Inherits
 * `currentColor`; size via className. Used on the store CTA button.
 */
export function SallaIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
